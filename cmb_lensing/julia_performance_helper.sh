...
#SBATCH --ntasks=4 #number of processor cores / tasks #also use --cpus-per-task... 
...
julia /resnick/groups/wugroup/zblood/cmb_lensing_reorganized/performance_test.jl --map_size $1 --seed $2 --trial $3